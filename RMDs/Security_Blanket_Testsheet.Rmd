...
knitr::opts_knit$set(root.dir = '~/master/Tardigrade_Directory')
setwd('~/master/Tardigrade_Directory')
getwd()
```
...
```{r Ohio, echo=FALSE}
# reading
data <- read_csv("data/ohio/test_ohio.csv")
map <- readOGR("data/ohio/fe_2007_39_county/fe_2007_39_county.shp")
```
